...
dataset_path = '/Users/neerajpadarthi/Neeraj/2nd Sem/python'
...
img1, kp1, des1 = image_detect_and_compute(sift, 'SwiftImage.png')
img2, kp2, des2 = image_detect_and_compute(sift, 'SwiftImageCrop.jpg')
